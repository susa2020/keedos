...
<?php
echo '<input type="search" name="question" class="search" id="ls_query_2" value="'.$search_question.'">' ;
  ...
  jQuery(document).ready(function(){
      jQuery(".search").ajaxlivesearch({
          ...
          onResultClick: function(e, data) {
            ...
            // set the input value
            jQuery('#ls_query_2').val(selectedOne);

            // hide the result
            jQuery("#ls_query_2").trigger('ajaxlivesearch:hide_result');
          },
          ...
          onAjaxComplete: function(e, data) {
              jQuery('#ls_query_2').val(<?php echo $search_question; ?>);
          }
      });
  })
  </script>
