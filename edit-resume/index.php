      ...
      <div class="container">
          <div class="row">
              <div class="col-md-8 col-lg-5 col-xl-6">
                  <h1 style="background: var(--light);text-align: left;">你好, 大拿</h1>
              </div>
              <div class="col-md-4 col-lg-7 col-xl-6 offset-xl-0">
                  <div class="resume-banner-status" style="background: var(--light);width: 200px;">
                      <div class="row">
                          <div class="col-lg-12">
                              <h1><i class="fa fa-circle"></i>已上傳至公開資料庫<br></h1>
                          </div>
                          <div class="col-xl-12 offset-xl-0">
                              <p>上次更新時間：<br>2021年2月18日<br>16:53分</p>
                          </div>
                      </div>
                  </div>
              </div>
                              ...
                              <form method="post" action="includes/edit-resume.inc.php" style="border-style: none;"><img class="rounded-circle img-fluid" src="assets/img/1.jpg" loading="lazy" style="padding: 10px;padding-top: 20px;padding-bottom: 20px;width: 120px;">
                                  ...
                                  <div class="container">
                                      ...
                                      <div class="form-row">
                                          ...
                                          <div class="col-md-6 col-lg-6 col-xl-6" style="border-top-left-radius: 1000;border-style: none;padding: 10px;padding-bottom: 10px;">
                                              <div class="form-group" style="margin-bottom: 0px;background: rgb(239, 241, 246);border-radius: 16px;">
                                                  <p style="margin-bottom: 0px;text-align: left;padding-left: 15px;border-radius: 16px;color: rgb(110,113,145);">專業連結(GitHub, LinkedIn...)</p><input class="form-control item" type="text" id="username-4" style="border-style: none;border-color: var(--white);margin-bottom: 0px;padding-bottom: 0px;padding-top: 0px;border-radius: 16px;text-align: left;" inputmode="url" name="pro_link">
                                              </div>
                                          </div>
                                      </div>
                                      <div class="form-row">
                                  ...
                                  <div class="container">
                                      <div class="form-row">
                                          <div class="col-md-12 col-lg-12 col-xl-12" style="border-top-left-radius: 1000;border-style: none;padding: 10px;padding-bottom: 10px;">
                                              <div class="form-group" style="margin-bottom: 0px;background: rgb(239, 241, 246);border-radius: 16px;">
                                                  <p style="margin-bottom: 0px;text-align: left;padding-left: 15px;border-radius: 16px;color: rgb(110,113,145);">其它關鍵字 (選填)</p><textarea class="form-control" style="border-style: none;height: 100px;text-align: left;" name="hashtag_else" spellcheck="true" required=""></textarea>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="container">
                                      <div class="form-row">
                                          <div class="col-md-12 col-lg-12 col-xl-12" style="border-top-left-radius: 1000;border-style: none;padding: 10px;padding-bottom: 10px;">
                                              <div class="form-group" style="margin-bottom: 0px;background: rgb(239, 241, 246);border-radius: 16px;">
                                                  <p style="margin-bottom: 0px;text-align: left;padding-left: 15px;border-radius: 16px;color: rgb(110,113,145);">自我介紹</p><textarea class="form-control" style="border-style: none;height: 200px;text-align: left;" name="self_ntro" spellcheck="true" required=""></textarea>
                                              </div>
                                          </div>
                                          <div class="col-md-12 col-lg-12 col-xl-12" style="border-top-left-radius: 1000;border-style: none;padding: 10px;padding-bottom: 10px;">
                                              <div class="form-group" style="margin-bottom: 0px;background: rgb(239, 241, 246);border-radius: 16px;">
